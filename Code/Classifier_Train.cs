...
class Classifier_Train: IDisposable
{
    ...
    {
        _IsTrained = LoadTrainingData("C:\\TrainedFaces\\");
    }
            ...
            try
            {
                            ...
                            switch (xmlreader.Name)
                            {
                                ...
                                case "FILE":
                                    if (xmlreader.Read())
                                    {
                                        ...
                                        trainingImages.Add(new Image<Gray, byte>("C:\\TrainedFaces\\" + xmlreader.Value.Trim()));
                                    }
                                    break;
                            }
                        }
                ...
                if (trainingImages.ToArray().Length != 0)
                {
                    ...
                    switch (Recognizer_Type)
                    {
                        ...
                        case("EMGU.CV.EigenFaceRecognizer"):
                        default:
                            recognizer = new EigenFaceRecognizer(80,                            // The 1st, is the number of components kept for this Principal Component Analysis.  
                                                                 double.PositiveInfinity);      // The 2nd variable is designed to be a prediction threshold;
                                                                                                // In the Eigen recogniser the larger the value returned the closer to a match we have.
                            break;
                    }
